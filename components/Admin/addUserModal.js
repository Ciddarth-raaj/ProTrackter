...
import { View, StyleSheet, Text, TouchableOpacity, Modal, Image, ScrollView, TextInput, Picker } from 'react-native';
					...
					<View style={[ styles.container ]}>
						...
						<ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
							...
							>
								...
								>
									{roles.map((r) => <Picker.Item label={r.label} value={r.role_id} />)}
								</Picker>
