...
export default function AddTaskModal(props) {
	...
	createTask = (title, description, projectId, deadline) => {
		const body = {
			title: title,
				...
				<View style={[ styles.container ]}>
					...
					<ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
						...
						>
							...
							<Picker selectedValue={projectId} itemStyle={styles.inputBox} onValueChange={setProjectId}>
								{projects.map((u) => <Picker.Item label={u.name} value={u.id} />)}
							</Picker>
