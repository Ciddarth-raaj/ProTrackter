...
export default function Header(props) {
    ...
    return (
        <TouchableOpacity
            ...
            <TaskModal visible={visible} setVisible={setVisible} color={color} title={title} product={product} assignee={assignee} description={description} taskHistory={taskHistory} />
            <View style={[styles.container, { backgroundColor: color }, type == 'modal' && { padding: 0 }]}>
                ...
                <View style={styles.imageWrapper}>
                    <Image source={require('../assests/hourglass.png')} style={styles.image} />
                </View>
            </View>
        </TouchableOpacity>
    );
